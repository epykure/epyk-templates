...
title = page.ui.title("Epyk a new library to link Python to JavaScript", options={"editable": True})
...
''', options={"markdown": True, "editable": True})

text = page.ui.text("Epyk will simplify your journey and allow you to learn those concepts !", options={"editable": True})
text.style.css.color = page.theme.colors[-1]
text.style.css.bold()
text.style.css.font_factor(5)

link = page.ui.link("Epyk Studio", "https://github.com/epykure/epyk-studio", options={"editable": True})
