...
scatter = rptObj.ui.charts.c3.scatter(data_chart, y_columns=[1], x_axis="x")
bar = rptObj.ui.charts.c3.line(data_chart, y_columns=[1, 2, 3], x_axis="x")
pie = rptObj.ui.charts.c3.pie(data_chart, y_columns=[1, 2, 3], x_axis="x")
button.click([
