...
bg.add(page.ui.texts.absolute("By clicking Sign Up, you agree to our Terms. Learn how we process your data in our Privacy Policy", align="center", size_notch=5, top=(60, "%")))

button = page.ui.buttons.absolute("SIGN UP", size_notch=5, top=(75, "%"))
