...
blablacar = page.ui.text('BlablaCar')
...
bg = page.ui.images.background(url="https://cdn.blablacar.com/kairos/assets/build/images/home_main_large-cf9833201f6f037587b180f79e147430.jpg", height=(500, "px"))
bg.add(page.ui.vignets.vignet("Emma. BlaBla. Mum.", "Carpooling takes the trek out of the journey.", width=("auto", "")))
...
title_style = {"width": '90%', 'margin': 'auto', 'font-weight': 800, 'line-height': '1.06', 'font-size': '30px', 'color': 'rgb(5, 71, 82)',
               'padding': '24px 0px'}

button = page.ui.button("Offer a ride", align="center")
...
v1 = page.ui.vignets.vignet(title="Choice", icon=svg, content="We go everywhere. Literally thousands of destinations. No station required.")
...
v2 = page.ui.vignets.vignet(title="Community", icon=svg,
...
v3 = page.ui.vignets.vignet(title="Get going faster", icon=svg,
                       content="No need to trek across town, catch a ride leaving near you.")


page.ui.row([v1, v2, v3], align="center", position="top")

button = page.ui.button("Discover the BlaBlaBus experience", align="center")
button.css(button_style)
button.style.css.margin_top = 10
content = page.ui.col([
...
page.ui.banners.text("Get started today!", size_notch=20)
b1 = page.ui.button("Find a ride", align="center").css(button_style)
b1.style.css.margin_bottom = 10

page.ui.button("Offer a ride", align="center").css(button_inv_style)